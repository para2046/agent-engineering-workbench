# Agent Engineering Workbench — design notes

*(The user-facing guide is the top-level README; this document keeps the full design rationale, grader semantics, and per-subsystem detail.)*
